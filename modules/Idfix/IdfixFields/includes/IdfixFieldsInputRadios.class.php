...
class IdfixFieldsInputRadios extends IdfixFieldsInputOptionsBase {
  ...
  public function GetEdit() {
    ...
    $cInline = (isset($this->aData['inline']) and $this->aData['inline']) ? 'radio-inline' : '';
    ...
    if (isset($this->aData['__RawPostValue']) and is_array($this->aData['__RawPostValue'])) {
  ...
  private function GetInputElement($cAttr, $cTitle, $cInlineClass) {
    ...
    if (!$cInlineClass) {
      $return = "<div class=\"radio\">{$return}</div>";
    }
    return $return;
