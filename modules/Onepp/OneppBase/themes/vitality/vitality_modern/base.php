...
<head>
    ...
    <link href="//cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.transitions.css" rel="stylesheet" type="text/css" />
    <link href="//cdnjs.cloudflare.com/ajax/libs/magnific-popup.js/1.0.0/magnific-popup.min.css" rel="stylesheet" type="text/css" />
    <link href="<?php print $_assets; ?>background.css" rel="stylesheet" type="text/css" />
    <link href="//cdnjs.cloudflare.com/ajax/libs/animate.css/3.3.0/animate.min.css" rel="stylesheet" type="text/css" />
    
    <!-- Vitality Theme CSS -->
    <link rel="stylesheet" href="<?php print $_assets; ?>vitality.css" type="text/css" />
...
<body id="page-top" class="modern">
    ...
    <script src="<?php print $_assets; ?>cbpAnimatedHeader.js"></script>
    <script src="//cdnjs.cloudflare.com/ajax/libs/owl-carousel/1.3.3/owl.carousel.js"></script>
    <script src="//cdnjs.cloudflare.com/ajax/libs/magnific-popup.js/1.0.0/jquery.magnific-popup.min.js"></script>
    <script src="<?php print $_assets; ?>core.js"></script>
    <script src="<?php print $_assets; ?>transition.js"></script>
    <script src="<?php print $_assets; ?>background.js"></script>
    <script src="//cdnjs.cloudflare.com/ajax/libs/mixitup/1.4.0/jquery.mixitup.min.js"></script>
    <script src="//cdnjs.cloudflare.com/ajax/libs/wow/1.1.2/wow.min.js"></script>
    
    <!-- Custom Theme JavaScript -->
    <script src="<?php print $_assets; ?>vitality.js"></script>
</body>
